 ...
 * Use the {@link Fragment_Editar_Historias#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Editar_Historias extends DialogFragment implements View.OnClickListener {

    // TODO: Rename parameter arguments, choose names that match
    // the fragment initialization parameters, e.g. ARG_ITEM_NUMBER
    private static final String ARG_PARAM1 = "param1";
    private static final String ARG_PARAM2 = "param2";
    public boolean anyHistoria = false;
    String id = "", historia = "";
    ...
    public Fragment_Editar_Historias() {
     ...
     * @return A new instance of fragment Fragment_Editar_Historias.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_Editar_Historias newInstance(String param1, String param2) {
        Fragment_Editar_Historias fragment = new Fragment_Editar_Historias();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_editar_historias, container, false);
    }
    ...
    public void onActivityCreated(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        user = Tools_Users_Defaults.user_id(getContext());
    ...
    public void editHistoria() {
        ...
        Call<RetrofitMessage> call = service.editHistoria(clinica,
                String.valueOf(id),
        ...
        call.enqueue(new Callback<RetrofitMessage>() {
            ...
            public void onResponse(Call<RetrofitMessage> call, Response<RetrofitMessage> response) {
                ...
                if (response.code() == 200) {
                    Toasty.success(getContext(), "Se ha editado una historia", Toasty.LENGTH_LONG).show();
                    anyHistoria =  true;
                    dismiss();
