 ...
 * Use the {@link Fragment_Editar_Pregunta#newInstance} factory method to
 * create an instance of this fragment.
 */
public class Fragment_Editar_Pregunta extends DialogFragment implements View.OnClickListener {
    ...
    Button btnClose, btnEditar, btnStatus;
    EditText txtPregunta;
    String id = "", clinica = "", pregunta = "", status = "", status2 = "Inactiva";
    ...
    public Fragment_Editar_Pregunta() {
     ...
     * @return A new instance of fragment Fragment_Editar_Pregunta.
     */
    // TODO: Rename and change types and number of parameters
    public static Fragment_Editar_Pregunta newInstance(String param1, String param2) {
        Fragment_Editar_Pregunta fragment = new Fragment_Editar_Pregunta();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_editar_pregunta, container, false);
    }
    ...
    public void onActivityCreated(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        btnStatus = getView().findViewById(R.id.btnStatus);
        txtPregunta = getView().findViewById(R.id.txtPregunta);
        btnStatus.setOnClickListener(this::onClick);
        ...
        if (!status.equals("Activa")) {
            status2 = "Activa";
            Drawable buttonDrawable = btnStatus.getBackground();
            buttonDrawable = DrawableCompat.wrap(buttonDrawable);
            DrawableCompat.setTint(buttonDrawable, getResources().getColor(R.color.green));
            btnStatus.setBackground(buttonDrawable);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.btnStatus: internetStatus(); break;
        }
    }
    ...
    public void editStatus() {
        ...
        Call<RetrofitMessage> call = service.editStatus(clinica,
                String.valueOf(id),
                status2);
        call.enqueue(new Callback<RetrofitMessage>() {
            ...
            public void onResponse(Call<RetrofitMessage> call, Response<RetrofitMessage> response) {
                ...
                if (response.code() == 200) {
                    Toasty.success(getContext(), "Se ha editado una pregunta", Toasty.LENGTH_LONG).show();
                    anyPregunta =  true;
                    dismiss();
    ...
    public void editPregunta() {
        progress_dialog.ShowProgressDialog();
        HistoriasService service = RetrofitClientInstance.getRetrofitInstance().create(HistoriasService.class);
        Call<RetrofitMessage> call = service.editPregunta(clinica,
                String.valueOf(id),
